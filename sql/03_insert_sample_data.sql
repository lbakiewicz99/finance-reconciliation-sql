...
VALUES
    ...
    (10, 'REFERENCE_MISMATCH', 'Reference mismatch', 'Normalized references differ although other transaction attributes suggest a possible match.', 'Medium');
...
OVERRIDING SYSTEM VALUE
VALUES
    (1001, 1, 1, 'TXN-2025-0001', 'TXN-2025-0001', 'SUBSCRIPTION', 'IN', 'USD', 125000.00, '2025-01-14', '2025-01-15', '2025-01-15', 'Multifonds', 'BOOKED'),
    (1002, 2, 3, 'TXN-2025-0002', 'TXN-2025-0002', 'REDEMPTION', 'OUT', 'EUR', 50000.00, '2025-01-15', '2025-01-16', '2025-01-16', 'Multifonds', 'BOOKED'),

    -- Internal-only break.
    (1003, 1, 1, 'TXN-2025-0003', 'TXN-2025-0003', 'FEE', 'OUT', 'USD', 750.00, '2025-01-16', '2025-01-17', '2025-01-17', 'Multifonds', 'BOOKED'),

    -- Amount mismatch. External raw reference differs, matching reference aligns.
    (1004, 1, 5, 'TXN-2025-0004', 'TXN-2025-0004', 'SUBSCRIPTION', 'IN', 'USD', 10000.00, '2025-01-17', '2025-01-20', '2025-01-20', 'Multifonds', 'BOOKED'),

    -- Date mismatch. External raw reference differs, matching reference aligns.
    (1005, 3, 4, 'TXN-2025-0005', 'TXN-2025-0005', 'DIVIDEND', 'IN', 'GBP', 2500.00, '2025-01-18', '2025-01-20', '2025-01-20', 'Multifonds', 'BOOKED'),

    -- Currency mismatch.
    (1006, 1, 2, 'TXN-2025-0006', 'TXN-2025-0006', 'CASH_TRANSFER', 'IN', 'EUR', 3000.00, '2025-01-21', '2025-01-22', '2025-01-22', 'Multifonds', 'BOOKED'),

    -- Duplicate internal records.
    (1007, 2, 3, 'TXN-2025-0007', 'TXN-2025-0007', 'INTEREST', 'IN', 'EUR', 125.50, '2025-01-23', '2025-01-24', '2025-01-24', 'Multifonds', 'BOOKED'),
    (1008, 2, 3, 'TXN-2025-0007', 'TXN-2025-0007', 'INTEREST', 'IN', 'EUR', 125.50, '2025-01-23', '2025-01-24', '2025-01-24', 'Multifonds', 'BOOKED'),

    -- Aged open break.
    (1009, 1, 1, 'TXN-2025-0008', 'TXN-2025-0008', 'CASH_TRANSFER', 'OUT', 'USD', 45000.00, '2025-01-05', '2025-01-06', '2025-01-06', 'Multifonds', 'BOOKED'),

    -- February exact match.
    (1010, 3, 4, 'TXN-2025-0009', 'TXN-2025-0009', 'SUBSCRIPTION', 'IN', 'GBP', 15000.00, '2025-02-10', '2025-02-11', '2025-02-11', 'Multifonds', 'BOOKED'),

    -- Reference mismatch.
    (1011, 1, 1, 'TXN-2025-0010', 'TXN-2025-0010', 'CASH_TRANSFER', 'IN', 'USD', 8000.00, '2025-01-26', '2025-01-27', '2025-01-27', 'Multifonds', 'BOOKED');
...
OVERRIDING SYSTEM VALUE
VALUES
    (5001, 1, 'TXN-2025-0001', 'TXN-2025-0001', 'BNK-STMT-20250115-001', 'SUBSCRIPTION', 'IN', 'USD', 125000.00, '2025-01-15', '2025-01-15', 'Investor A', 'Bank'),
    (5002, 3, 'TXN-2025-0002', 'TXN-2025-0002', 'CUST-STMT-20250116-001', 'REDEMPTION', 'OUT', 'EUR', 50000.00, '2025-01-16', '2025-01-16', 'Investor B', 'Custodian'),

    -- External-only break.
    (5003, 1, 'BNK-FEE-20250117-001', 'TXN-2025-EXT1', 'BNK-STMT-20250117-001', 'FEE', 'OUT', 'USD', 120.00, '2025-01-17', '2025-01-17', 'Bank Fee', 'Bank'),

    -- Amount mismatch. Raw reference differs, matching reference aligns.
    (5004, 5, 'PSP-CAPTURE-TXN-2025-0004', 'TXN-2025-0004', 'PSP-STMT-20250120-001', 'SUBSCRIPTION', 'IN', 'USD', 9995.00, '2025-01-20', '2025-01-20', 'Investor C', 'PSP'),

    -- Date mismatch. Raw reference differs, matching reference aligns.
    (5005, 4, 'BNK-DIV-TXN-2025-0005', 'TXN-2025-0005', 'BNK-STMT-20250121-001', 'DIVIDEND', 'IN', 'GBP', 2500.00, '2025-01-21', '2025-01-21', 'Dividend Agent', 'Bank'),

    -- Currency mismatch. Raw reference differs, matching reference aligns.
    (5006, 2, 'BNK-TRANSFER-TXN-2025-0006', 'TXN-2025-0006', 'BNK-STMT-20250122-001', 'CASH_TRANSFER', 'IN', 'USD', 3000.00, '2025-01-22', '2025-01-22', 'Treasury Transfer', 'Bank'),

    -- External record matching duplicated internal records.
    (5007, 3, 'CUST-INT-TXN-2025-0007', 'TXN-2025-0007', 'CUST-STMT-20250124-001', 'INTEREST', 'IN', 'EUR', 125.50, '2025-01-24', '2025-01-24', 'Custodian Interest', 'Custodian'),

    -- Duplicate external records.
    (5008, 1, 'BNK-FEE-DUP-20250125-001', 'TXN-2025-EXT2', 'BNK-STMT-20250125-001', 'FEE', 'OUT', 'USD', 35.00, '2025-01-25', '2025-01-25', 'Bank Fee', 'Bank'),
    (5009, 1, 'BNK-FEE-DUP-20250125-001', 'TXN-2025-EXT2', 'BNK-STMT-20250125-001', 'FEE', 'OUT', 'USD', 35.00, '2025-01-25', '2025-01-25', 'Bank Fee', 'Bank'),

    -- February exact match.
    (5010, 4, 'TXN-2025-0009', 'TXN-2025-0009', 'BNK-STMT-20250211-001', 'SUBSCRIPTION', 'IN', 'GBP', 15000.00, '2025-02-11', '2025-02-11', 'Investor D', 'Bank'),

    -- Reference mismatch. Same core attributes, different normalized reference.
    (5011, 1, 'BNK-TRANSFER-UNKNOWN-20250127', 'TXN-2025-9999', 'BNK-STMT-20250127-001', 'CASH_TRANSFER', 'IN', 'USD', 8000.00, '2025-01-27', '2025-01-27', 'Treasury Transfer', 'Bank');
...
VALUES
    ...
    (14, 1, 1011, 5011, 10, 'MISMATCH', 'OPEN', '2025-01-31', NULL, 0.00, 0, 'Potential same transaction based on account, amount, currency and date, but normalized references differ.');
